...
<'a><'button id="button-ok-1" acceskey="O" disabled>Ok<'/a>
...
<br><em onmouseover="changeColor(this.parentNode)" onmouseout="changeColor(this.parentNode)"><'em onmouseover="changeColor(this.parentNode)" onmouseout="changeColor(this.parentNode)">HTML tags and attributes<'/em></em>
